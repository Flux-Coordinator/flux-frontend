...
export default class FluxHeatmap extends React.Component<Props,
    State> {
    state = {
        elementHeight: 0,
        elementWidth: 0
    ...
    render() {
        return (
            <div ref={divElement => (this.divElement = divElement)} style={{float: 'left'}}>
                <img src={this.props.backgroundImage} alt={"heatmap"}
